...
public final class MDKVideoToolboxEncodingProcessor: MDKCaptureFrameProcessing, @unchecked Sendable {
    ...
    private let maximumRealTimeFrameRateMatchesExpectedFrameRate: Bool
    ...
    public init(
        ...
        maximumRealTimeFrameRateMatchesExpectedFrameRate: Bool = false
    ) {
        self.codec = codec
        ...
        self.maximumRealTimeFrameRateMatchesExpectedFrameRate = maximumRealTimeFrameRateMatchesExpectedFrameRate
    ...
    private func ensureCompressionSession(
        ...
        let maximumRealTimeFrameRateHint =
            ...
            ? (
                maximumRealTimeFrameRateMatchesExpectedFrameRate
                    ? targetFrameRate
        ...
        if #available(macOS 15.0, *),
            let maximumRealTimeFrameRateHint {
            sessionConfigurationNotes.append(
                "videoToolboxMaximumRealTimeFrameRatePolicy=\(maximumRealTimeFrameRateMatchesExpectedFrameRate ? "expected-frame-rate" : "expanded")"
            )
            setSessionProperty(
                session,
