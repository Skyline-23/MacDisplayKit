...
public final class MDKVideoToolboxEncodingProcessor: MDKCaptureFrameProcessing, @unchecked Sendable {
    ...
    private func runtimeNotes(
        ...
        var notes = [
            ...
            "videoToolboxStagedSubmissionPreparation=precomputed-frame-state",
    ...
    private func stageAndEncode(
        ...
        hdrConfiguration?.apply(to: stagedPixelBuffer.pixelBuffer)
            ...
            self.submissionQueue.async { [self] in
                do {
                    try submitToEncoder(
                        ...
                        shouldApplyHDRConfiguration: false,
                        releasePendingFrame: {}
                    )
                    releaseSourceFrame()
    ...
    private func submitToEncoder(
        ...
        shouldApplyHDRConfiguration: Bool = true,
        releasePendingFrame: @escaping @Sendable () -> Void = {}
    ) throws {
        ...
        if shouldApplyHDRConfiguration {
