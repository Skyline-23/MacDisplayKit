...
private final class MDKEncodedTileStreamProcessor: MDKEncodedCaptureProcessorRuntime, @unchecked Sendable {
    ...
    private let logicalTargetFrameRate: Int
    ...
    private var nextLogicalPresentationFrameIndex: Int64 = 0
    ...
    init(
        ...
        self.logicalTargetFrameRate = max(configuration.targetFrameRate, 1)
    ...
    func process(
        ...
        let presentationTimeStamp = CMTime(
            value: nextLogicalPresentationFrameIndex,
            timescale: Int32(logicalTargetFrameRate)
        )
        nextLogicalPresentationFrameIndex += 1
        ...
        do {
            for laneIndex in regions.indices {
                try processor.process(
                    ...
                    presentationTimeStampOverride: presentationTimeStamp
                )
    ...
    private func summarize(_ summaries: [MDKCaptureFrameProcessingSummary]) -> MDKCaptureFrameProcessingSummary? {
        ...
        var notes = [
            ...
            "videoToolboxEncodedTileStreamPresentationTimestampMode=shared-logical-frame"
        ]
