...
- `389-391`도 닫혔다. synthetic SkyLight timer replay를 아예 끄거나, source pending-idle / VT pending 기준으로 억제해도 official metric은 `92.29-92.71` 범위에 머물렀다. replay는 지금 경로에서 단순 중복이 아니라 progression 유지에 실제로 기여하고 있다.
